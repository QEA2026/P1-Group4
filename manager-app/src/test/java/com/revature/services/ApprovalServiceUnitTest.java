...
class ApprovalServiceUnitTest {
        ...
        @Test
        void reviewExpense_mixedCaseStatus_ToLower() {
        ...
        @Test
        void reviewExpense_nullStatus_IllegalArgumentException() {
        ...
        @Test
        void reviewExpense_invalidStatus_IllegalArgumentException() {
        ...
        @Test
        void reviewExpense_emptyStatus_IllegalArgumentException() {
        ...
        //sad paths DAO
        @Test
        void reviewExpense_daoReturnsFalse() {
        ...
        @Test
        void reviewExpense_daoThrowsResourceNotFoundException() {
